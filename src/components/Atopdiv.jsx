...
<button className=" cursor-pointer bg-gray-50 py-3 text-black hover:bg-gray-300"><Link to="/Sechome">Home</Link></button>
...
<label> <button className=" cursor-pointer  mt-8  bg-gray-50 text-black hover:bg-blue-300  "> <Link to="/Adentist">Dentist</Link></button></label></div>
<div className="flex flex-row">
 ...
 <label> <button className=" cursor-pointer   bg-gray-50 text-black hover:bg-blue-300 mt-2 ml-3 "> <Link to="/Acardiologist">Cardiologist</Link></button></label></div>
 <div className="flex flex-row">
 ...
 <label> <button className=" cursor-pointer   bg-gray-50 text-black hover:bg-blue-300 mt-3 ml-2"> <Link to="/Aorthopedic">Orthopedic</Link></button></label></div>
 <div className="flex flex-row">
 ...
 <label> <button className=" cursor-pointer   bg-gray-50 text-black hover:bg-blue-300 ml-2 mt-2"><Link to="/Aneurologist">Neurologist</Link></button></label></div>
 <div className="flex flex-row">
 ...
 <label> <button className=" cursor-pointer ml-2 mt-2 bg-gray-50 text-black hover:bg-blue-300 "> <Link to="/Aotologist">Otologist</Link></button></label></div>
 <div className="flex flex-row">
 ...
 <label> <button className=" cursor-pointer  mt-2.5 bg-gray-50 text-black hover:bg-blue-300 "> <Link to="/Aeye">Eye Specialist</Link></button></label></div>
 <div className="flex flex-row">
 ...
 <label> <button className=" cursor-pointer  mt-2.5 bg-gray-50 text-black hover:bg-blue-300 "> <Link to="/Asurgon"> Surgon</Link></button></label></div> 
 <div className="flex flex-row">
...
<label> <button className=" cursor-pointer  mt-2.5 bg-gray-50 text-black hover:bg-blue-300 "> <Link to="/Ageneral"> General Doctor</Link></button></label></div>
</div>
    </div>
    </div>
  )
