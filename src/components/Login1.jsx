    ...
    <div className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12 bg-cover" style={{backgroundImage: "url('https://wallpapercave.com/wp/wp2655088.jpg')"}}>
      <div className="relative z-10">
        <div className="relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
          <h1 className="text-sm font-bold text-black">Login</h1>
          <form className="flex flex-col gap-3">
            ...
            <div className="flex flex-row justify-between mt-4">
              ...
              >
                 <Link to="/Sechome">Login</Link>
              </button>
              <Link to="/signup">
                <button className="text-blue-500">
                  <span className="underline">Don't have an account? <Link to="/Signup1">Signup</Link></span>
                </button>
              </Link>
            </div>
          </form>
