...
const Sechome = () => {
  return (
    ...
    <div className="relative">
      <video autoPlay muted loop id="bg-video" className="fixed top-0 left-0 min-w-full min-h-full z-0 opacity-50">
        <source src="https://videocdn.cdnpk.net/joy/content/video/free/video0453/large_preview/_927__import.mp4?file=1102461_1080p_document_pen_1920x1080.mp4" type="video/mp4" />
    ...
    <div className="relative">
        ...
        <div className="relative inline-block text-left">
            <button type="button" className="cursor-pointer bg-gray-50 p-3 rounded-full hover:bg-gray-300" onClick={() => document.getElementById('dropdown').classList.toggle('hidden')}>
             ...
             <div id="dropdown" className="absolute right-0 mt-2 w-56 rounded-md bg-white shadow-lg z-10 hidden">
                <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem"> <Link to="/Patienthis">Patient History</Link></a>
                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem"><Link to="/AddDoc">Add Doctor</Link></a>
                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem"><Link to="/Home">Logout</Link></a>
                </div>
            </div> 
        </div>
    </div>
  ...
  <div className="relative flex flex-col items-center">
    ...
    <button className="absolute bottom-0 cursor-pointer bg-gray-50 bg-opacity-50 py-3 px-5 ml-3 text-black text-xl">
      <Link to="/Acardiologist">Cardiologist</Link>
    </button>
  </div>
  ...
  <div className="relative flex flex-col items-center">
    ...
    <button className="absolute bottom-0 cursor-pointer bg-gray-50 bg-opacity-50 py-3 px-5 ml-3 text-black text-xl">
      <Link to="/Aorthopedic">Orthopedic</Link>
    </button>
  </div>
  ...
  <div className="relative flex flex-col items-center">
    ...
    <button className="absolute bottom-0 cursor-pointer bg-gray-50 bg-opacity-50 py-3 px-5 ml-3 text-black text-xl">
      <Link to="/Aneurologist">Neurologist</Link>
    </button>
  </div>
  ...
  <div className="relative flex flex-col items-center">
    ...
    <button className="absolute bottom-0 cursor-pointer bg-gray-50 bg-opacity-50 py-3 px-5 ml-3 text-black text-xl">
      <Link to="/Aotologist">Otologist</Link>
    </button>
  </div>
</div>
  <h1 className="text-black font-extrabold mt-4">Popular Doctors</h1>
          <div className="flex flex-row gap-32 mt-3 ">
            <div className="flex flex-col border border-blue-900 ">
              ...
              <button className="cursor-pointer  rounded-full border border-blue-800  px-3 mt-2 text-white bg-blue-600 hover:bg-blue-300">Book Now</button>
            </div>
            <div className="flex flex-col border border-blue-900">
